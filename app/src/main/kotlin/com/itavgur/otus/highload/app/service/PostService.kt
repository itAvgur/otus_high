...
import com.itavgur.otus.highload.app.dao.PostDao
import com.itavgur.otus.highload.app.exception.PostNotFoundException
...
class PostService(
    ...
    @Value(value = "\${cache.post-feed.enabled:true}")
    var postFeedCacheEnabled: Boolean = true
    ...
    @Cacheable("post-feed", key = "{#userId}", condition = "#root.target.postFeedCacheEnabled")
